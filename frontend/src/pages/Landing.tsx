...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-[calc(100svh-72px)] overflow-x-hidden bg-[#070d14] text-slate-100 lg:h-[calc(100svh-72px)] lg:overflow-hidden">
      <main className="relative min-h-[calc(100svh-72px)] overflow-x-hidden lg:h-[calc(100svh-72px)] lg:overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_62%_40%,rgba(17,82,96,0.34),transparent_38%),linear-gradient(135deg,#071019_0%,#0c1923_52%,#07121b_100%)]" />
        <div className="absolute inset-0 opacity-90 [background-image:linear-gradient(rgba(118,148,164,0.075)_1px,transparent_1px),linear-gradient(90deg,rgba(118,148,164,0.075)_1px,transparent_1px)] [background-size:46px_46px] [mask-image:radial-gradient(ellipse_at_center,black_42%,transparent_94%)]" />
        ...
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,rgba(4,9,14,0.88)_0%,rgba(4,9,14,0.68)_30%,rgba(4,9,14,0.05)_59%,rgba(4,9,14,0.1)_100%)]" />
