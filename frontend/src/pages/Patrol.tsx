    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-4">
        <Card className="rounded-[28px] border border-slate-800 bg-slate-950/70 p-5 shadow-lg">
          <p className="text-xs uppercase tracking-[0.24em] text-slate-500 font-semibold">Total Patrol Stops</p>
          <p className="mt-4 text-3xl font-bold text-white">{total_stops}</p>
        </Card>
        <Card className="rounded-[28px] border border-slate-800 bg-slate-950/70 p-5 shadow-lg">
          <p className="text-xs uppercase tracking-[0.24em] text-slate-500 font-semibold">Critical/High Stops</p>
          <p className="mt-4 text-3xl font-bold text-rose-400">{critical_high_stops}</p>
        </Card>
        <Card className="rounded-[28px] border border-slate-800 bg-slate-950/70 p-5 shadow-lg">
          <p className="text-xs uppercase tracking-[0.24em] text-slate-500 font-semibold">Total Distance</p>
          <p className="mt-4 text-3xl font-bold text-white font-mono">{total_distance_km} km</p>
        </Card>
        <Card className="rounded-[28px] border border-slate-800 bg-slate-950/70 p-5 shadow-lg">
          <p className="text-xs uppercase tracking-[0.24em] text-slate-500 font-semibold">Est. Dispatch Duration</p>
          <p className="mt-4 text-3xl font-bold text-cyan-300 font-mono">{estimated_travel_time_minutes} min</p>
        </Card>
      </div>
